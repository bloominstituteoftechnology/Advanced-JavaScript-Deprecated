...
const result = me.checkPass('correcthorsebatterystaple'); // should return `true`
...
// .call
const callCheckPass = checkPassword.call(me, 'correcthorsebatterystaple');

// .apply
const applyCheckPass = checkPassword.apply(me, ['correcthorsebatterystaple']);

// .bind
const bindCheckPass = checkPassword.bind(me);
const boundPass = bindCheckPass('correcthorsebatterystaple');
