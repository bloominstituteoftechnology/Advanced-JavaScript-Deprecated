...
class User {
  constructor(options) {
    ...
    this.checkPassword = string => string === this.password;
  }
...
const checkPassword = passwordToCompare => this.password === passwordToCompare;
...
// .call
console.log(checkPassword.call(this, User.password));
// .apply
console.log(checkPassword.apply(this, User.password));
// .bind
console.log(checkPassword.bind(this)());
