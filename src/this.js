...
// console.log(me.checkPassword.call('correcthorsebatterystaple'));
// invoke `checkPassword` on `me` by explicitly setting the `this` context
// use .call, .apply, and .bind

// .call
const checkApp = checkPassword.call(me, 'correcthorsebatterystaple');
// console.log(checkApp);
// .apply

const checkCa = checkPassword.apply(me, ['correcthorsebatterystaple']);
// console.log(checkCa);

// .bind
const look = checkPassword.bind(me, 'correcthorsebatterystaple');
// console.log(look());
